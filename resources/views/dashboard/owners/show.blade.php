...
@section('content')
    ...
    <div class="form-group">
        <div class="row center">
            {{-- Nombre del dueño --}}
            <div class="col  mb-3">
                <input readonly class="form-control" type="text" name="name" id="name" placeholder="Nombre dueño"
        ...
        <div class="form-group">
            <div class="row">
                <div class="col mb-3">
                    <select readonly class="form-control" name="document_type" id="document_type">
                        @include('dashboard/partials/options_document',['val' => $owner->document_type])
                    </select>
                </div>
                {{-- Nùmero de document --}}
                <div class="col mb-3">
                    <input readonly class="form-control" type="text" name="document" id="document"
